...
class PDFProcessor:
    ...
    def process_pdf(self, pdf_path: str, output_dir: str, doc_id: str) -> Dict:
        ...
        processing_results = {
            ...
            "pages": {},
            "processing_summary": {"pages_with_text": 0},
        }
        ...
        print(
            f"      -> Pages with text: {processing_results['processing_summary']['pages_with_text']}"
        )
    ...
    def _extract_text(
        self, page: fitz.Page, page_dir: str, page_number: int
    ) -> Optional[str]:
